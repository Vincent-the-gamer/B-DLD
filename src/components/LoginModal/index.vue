<template>
  <a-modal
        ...
        <div class="login-box">
          <a-input v-model:value="IPTSESSDATA" placeholder="输入你的SESSDATA">
            <template #suffix>
              <a-tooltip>
                <template #title>
                  <a @click="openBrowser('https://github.com/Vincent-the-gamer/BilibiliVideoDownload/wiki/%E8%8E%B7%E5%8F%96SESSDATA')">点击此处</a>查看如何获取SESSDATA
                </template>
    ...
    <div class="mt16 desc">注：软件登录后只会获取你的SESSDATA来用做下载，账号是普通账号下载1080P视频，大会员可以下载8K视频，不登录下载480P视频
      <br/>
      理论上不登录也有1080P选项，试试吧(*^▽^*)</div>
  </a-modal>
</template>
