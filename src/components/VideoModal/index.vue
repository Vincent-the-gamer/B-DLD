    ...
    <div class="video-modal custom-scroll-bar">
      <div class="video-info fr">
        ...
        <div class="content fc jsa pl16">
          ...
          <div class="ellipsis-1">UP主：<span v-for="(item, index) in videoInfo.up" :key="index" class="text-active mr8" @click="openBrowser(`https://space.bilibili.com/${item.mid}`)">{{item.name}}</span></div>
        </div>
      </div>
      <div class="mt16">
        选择清晰度：
